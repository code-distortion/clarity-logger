...
class LaravelPipeUnitTest extends LaravelTestCase
{
    ...
    public static function test_clarity_context_pipe(): void
    {
        ...
        $output = 'CONTEXT DETAILS:' . PHP_EOL
            . PHP_EOL
            . '%TEST_PATH% on line %CONTEXT_METADATA_LINE_1% (method "testPipeline")' . PHP_EOL
            . '- id = 123' . PHP_EOL
            . PHP_EOL
            . '%TEST_PATH% on line %CONTEXTS_EXCEPTION_THROWN_LINE% (closure)' . PHP_EOL
            . '- The exception was thrown';
        ...
        $output = 'CONTEXT DETAILS:' . PHP_EOL
            ...
            . '- "hello1"' . PHP_EOL
            . PHP_EOL
            . '%TEST_PATH% on line %CONTEXT_METADATA_LINE_2% (method "testPipeline")' . PHP_EOL
            . '- "hello2"' . PHP_EOL
            . PHP_EOL
            . '%TEST_PATH% on line %CONTEXTS_EXCEPTION_THROWN_LINE% (closure)' . PHP_EOL
            . '- The exception was thrown';
    ...
    public static function test_message_pipe(): void
    {
        ...
        self::testPipeline(
            pipeClass: MessagePipe::class,
            pipelineInput: self::newPipelineInput(message: 'hello'),
            expectedOutput: $output,
            expectedErrorOutput: $output,
        );
    }
     ...
     * @return void
     */
    private static function testPipeline(
        string $pipeClass,
        PipelineInput $pipelineInput,
        string $expectedOutput,
        string $expectedErrorOutput,
        ?callable $updateControlObject = null,
        bool $useClarityContext = true,
    ...
    {
        $projectRoot = Framework::config()->getProjectRoot();

        $functionsPathLong = "{$projectRoot}tests/Support/Functions.php";
        $functionsPathLong = ltrim($functionsPathLong, DIRECTORY_SEPARATOR);

        $replace = [
            '%TEST_PATH%' => 'tests/Unit/Pipelines/LaravelPipeUnitTest.php',
            ...
            '%EXCEPTION_THROWN_LINE%' => __LINE__ - 56,
            '%CONTEXTS_EXCEPTION_THROWN_LINE%' => __LINE__ - 34,
        ];
    ...
    private static function runPipeline(
        ...
        $pipe = self::make($pipeClass, ['input' => $input, 'output' => $output]);
    ...
    /**
     * Build an object, using Laravel's dependency injection.
     *
     * @param string  $class   The class to build.
     * @param mixed[] $payload Extra parameters to include.
     * @return mixed
     */
    private static function make(string $class, array $payload): mixed
    {
        /** @var Application $app */
        $app = app();
        return $app->make($class, $payload);
    }
