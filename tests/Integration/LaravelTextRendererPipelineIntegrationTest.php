...
use CodeDistortion\ClarityLogger\Tests\Support\UserModel;
use Exception;
    ...
    private static function renderClarityContext(
        ...
        if ($exceptionThrownLine) {
            ...
            return PHP_EOL
                ...
                . PHP_EOL
                . "tests/Integration/LaravelTextRendererPipelineIntegrationTest.php on line $contextLine "
                    . "(method \"test_text_renderer_output\")" . PHP_EOL
                . "- \"something\"" . PHP_EOL
                . "- a = 'b'" . PHP_EOL
                . PHP_EOL
                . "tests/Integration/LaravelTextRendererPipelineIntegrationTest.php on line $exceptionCaughtLine "
                    . "(method \"test_text_renderer_output\")" . PHP_EOL
                . "- The exception was caught (by Clarity)" . PHP_EOL
                . PHP_EOL
                . "tests/Integration/LaravelTextRendererPipelineIntegrationTest.php on line $exceptionThrownLine "
                    . "(closure)" . PHP_EOL
