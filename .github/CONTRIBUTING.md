...
- **Document any change in behaviour** - Clearly note any changes, so [Clarity Logger's documentation](https://github.com/code-distortion/clarity-logger) can be updated.
