...
use CodeDistortion\ClarityLogger\Output\BasicTable;
use CodeDistortion\ClarityLogger\Output\OutputInterface;
use CodeDistortion\ClarityLogger\Output\Text;
...
//        }
    ...
    /**
     * Retrieve a new BasicTable object to use.
     *
     * @param boolean $reusableAfter Whether this object can be reused later.
     * @return BasicTable
     * @throws ClarityLoggerPipelineException If BasicTable doesn't implement OutputInterface.
     */
    public function newTable(bool $reusableAfter = true): BasicTable
    {
        /** @var BasicTable $return */
        $return = $this->use(BasicTable::class, true, $reusableAfter);

        return $return;
    }

    /**
     * Retrieve a BasicTable object to use, reuse if the previous one was a BasicTable as well.
     *
     * @param boolean $reusableAfter Whether this object can be reused later.
     * @return BasicTable
     * @throws ClarityLoggerPipelineException If BasicTable doesn't implement OutputInterface.
     */
    public function reuseTableOrNew(bool $reusableAfter = true): BasicTable
    {
        /** @var BasicTable $return */
        $return = $this->use(BasicTable::class, false, $reusableAfter);
     ...
     */
    public function newText(bool $reusableAfter = true): Text
    {
        /** @var Text $return */
        $return = $this->use(Text::class, true, $reusableAfter);
     ...
     * @throws ClarityLoggerPipelineException If Text doesn't implement OutputInterface.
     */
    public function reuseTextOrNew(bool $reusableAfter = true): Text
    {
        /** @var Text $return */
        $return = $this->use(Text::class, false, $reusableAfter);
