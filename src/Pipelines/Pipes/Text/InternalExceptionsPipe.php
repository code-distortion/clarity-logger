...
{
    /** @var Text The Text that can be used later to render internal exceptions. */
    private Text $text;

    /** @var BasicTable The BasicTable that can be used later to render internal exceptions. */
