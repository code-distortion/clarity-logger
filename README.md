...
Clarity Logger is a part of the ***Clarity Suite***:
...
If you add [code-distortion/clarity-context](https://github.com/code-distortion/clarity-context) to your project, Clarity Logger will include its context details automatically.
...
app/Domain/Payments/MakePaymentAction.php on line 19 (last application frame) (method "handle")
